...
<section class="content-header">
  ...
  <?php include('mysql/config.php');
          ...
          <div align="right"> 
        <a href="search_regdel.php">   
      <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#exampleModal">
        <i class="fa fa-file"></i>รายงานข้อมูลลงทะเบียน/ยกเลิกผู้ใช้งาน </button></a>
          ...
          <div class="col-md-12">
              ...
              <thead>
                <tr role="row" class="info">
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 4%;">สถานะ</th>
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;">ผู้ให้บริการ</th>
                   <th  tabindex="0" rowspan="1" colspan="1" style="width: 6%;">-</th>
                </tr>
              </thead>
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-xs" href="adm_detail_sys.php?system_num=<?php echo $system_num;?>" 
                      >
                      <i class="fas fa-eye">
                      </i>
                    </a> 
                    <a class="btn btn-warning btn-xs" href="adm_form_sys.php?system_num=<?php echo $system_num; ?>" >
                      <i class="fas fa-pencil-alt">
                      </i>
                    </a>

                    <a class="btn btn-danger btn-xs" href="adm_deleted_sys.php?system_num=<?php echo $system_num ?>" >
