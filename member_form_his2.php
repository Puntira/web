...
<table width="500">
        ...
        <form action="member_update_his2.php" method="POST">
<tr>
...
<tr>
            ...
            <td><input type="text" name="requestnumbr" value="<?php echo  $_SESSION["requestnumbr"]=$requestnumbr; ?>"  hidden/>
                <input type="text" name="requestnumbr" value="<?php echo $requestnumbr; ?>" readonly /></td>
</tr>
<tr>
            <td><font color="red">วันที่ขอใช้บริการ : </font></td>
            <td><input type="text" name="requestdatebr" value="<?php echo  $_SESSION["requestdatebr"]=$requestdatebr; ?>" hidden />
                <input type="text" name="requestdatebr" value="<?php echo $requestdatebr; ?>" readonly /></td>
</tr>
<tr>
            <td>ผู้ขอใช้บริการ : </td>
            <td><input type="text" name="requesterbr" value="<?php echo $_SESSION["requesterbr"]=$requesterbr; ?>" hidden/>
                <input type="text" name="requesterbr" value="<?php echo $requesterbr; ?>"  readonly/></td>
</tr>
<tr>
            <td>รหัส : </td>
            <td><input type="text" name="requesteridbr" value="<?php echo $_SESSION["requesteridbr"]=$requesteridbr; ?>" hidden/>
                <input type="text" name="requesteridbr" value="<?php echo $requesteridbr; ?>" pattern="[0-9]{5}" title="กรอกรหัสพนักงาน หรือ ลูกจ้างไม่ถูกต้อง"/></td>
</tr>
<tr>
            <td>ตำแหน่ง : </td>
            <td>
...
<tr>
            <td>โทรภายใน : </td>
            <td><input type="text" name="telinbr" value="<?php echo $_SESSION["telinbr"]=$telinbr; ?>" hidden/>
                <input type="text" name="telinbr" value="<?php echo $telinbr; ?>" pattern="^[0-9]{4,10}" title="กรอกตัวเลขเท่านั้น 4 ตัวอักษรขึ้นไป" /></td>
</tr>
<tr>
            <td>รายการอุปกรณ์ : </td>
            <td>
                 <select name="requestcasebr" id="requestcasebr">
                    <option value="none" disabled selected>กรุณาเลือกรายการ</option>
...
<tr>
            <td>รหัสครุภัณฑ์ : </td>
            <td><input type="text" name="codeitembr" value="<?php echo $_SESSION["codeitembr"]=$codeitembr; ?>" hidden/>
                <input type="text" name="codeitembr" value="<?php echo $codeitembr; ?>"  /></td>
</tr>
<tr>
            <td>เพื่อใช้ในงาน : </td>
            <td><input type="text" name="requestnotebr" value="<?php echo $_SESSION["requestnotebr"]=$requestnotebr; ?>" hidden/>
                <textarea rows="1" cols="25" name="requestnotebr" ><?php echo $requestnotebr; ?></textarea><br /></td>
</tr>
<tr>
            ...
            <input type="text" name="requeststatusbr" value="<?php echo $_SESSION["requeststatusbr"]=$requeststatusbr; ?>" hidden/>
...
<tr>
            <td>
                <button type="button" class="btn btn-warning btn-xs" onclick="window.history.back();">ย้อนกลับ</button>
        ...
        <script>
            ...
            document.getElementById('requestcasebr').value = '<?php echo $requestcasebr; ?>';
