...
<div align="left"> 
    ...
    <a href="boss1_form_ser_pass.php?memberid=<?php echo $memberid;?>">   
    <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#exampleModal">
...
<tr>
   ...
   <tr>
    ...
    <tr>     
        <td><font color="orange">รายละเอียด ระบบเครือข่าย : </font></td>
     ...
     <tr>     
        <td><font color="orange">รายละเอียด ระบบฐานข้อมูล : </font></td>
        <td><div style="padding-left: 5px;">
            <font color="green">
            <?php echo preg_replace("/\r?\n/", "<br />", $membernote2); ?>     
            </font>
