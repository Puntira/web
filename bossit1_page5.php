            ...
            <table id="example1" class="table table-bordered table-striped dataTable" 
              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-xs" href="bossit1_detail_devsys_pass.php?devsys_num=<?php echo $devsys_num;?>" 
                     >
                      <i class="fas fa-eye">
                      </i>
                   
                    </a>                         
                   <a class="btn btn-warning btn-xs" href="bossit1_form_devsys_pass.php?devsys_num=<?php echo $devsys_num; ?>" >
