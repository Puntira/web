...
<table width="500">
        ...
        <form action="boss1_update_devsys_pass.php" method="POST">
<tr>
            <td>เลขที่ขอ : </td>
...
<tr>
            ...
            <td><select name="b_dev_status" id="b_dev_status" hidden >
...
<tr>
            ...
            <td><input type="date" name="b_dev_date" value="<?php echo $b_dev_date; ?>"  hidden /></td>
</tr>
<tr>
            <td hidden>หมายเหตุคำขอ : </td>
            <td><textarea name="b_dev_note" rows="4" cols="40" hidden><?php echo $b_dev_note; ?></textarea><br /></td>
</tr>
<tr>
            <td hidden>ลงชื่อ หน.ส่วนงาน M: </td>
            <td><input type="text" name="b_dev_name" value="<?php echo $b_dev_name; ?>"  hidden/></td>
</tr>
 
    <tr>
            <td>ความเห็นผู้อำนวยการ M: </td>
            <td><select name="b1_dev_status" id="b1_dev_status" >
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            ...
            <td><input type="date" name="b1_dev_date" value="<?php echo $b1_dev_date; ?>"  required /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="b1_dev_note" rows="4" cols="40" required><?php echo $b1_dev_note; ?></textarea><br /></td>
</tr>
<tr>
            <td>ลงชื่อผู้อำนวยการ M: </td>
            <td><input type="text" name="b1_dev_name" value="<?php echo $b1_dev_name; ?>"  required/></td>
</tr>
