...
<table width="500">
        ...
        <form action="bossit1_update_devsys_pass.php" method="POST">
<tr>
            <td>เลขที่ขอ : </td>
...
<tr>
            <td>วันที่ขอ : </td>
            <td><input type="text" value="<?php echo date("d/m/Y",strtotime("+543 year".$devsysdate)); ?>" readonly /></td>
</tr>
<tr>
            <td>ผู้ขอ : </td>
...
<tr>
            <td>มีความประสงค์ : </td>
            <td><input type="text"  value="<?php echo $lis_devsysname[$lis_devsys]; ?>" readonly></td>
</tr>
<tr>
            <td>ผู้ใช้งานระบบ : </td>
...
<tr>
            ...
            <td><textarea name="note_devsys" rows="4" cols="40" readonly><?php echo $note_devsys; ?></textarea><br /></td>
</tr>
<tr>
            <td>สถานะผู้ขอ : </td>
...
<!--tr>
            ...
            <td><select name="b_dev_status" id="b_dev_status" require >
...
<tr>
            ...
            <td><input type="date" name="b_dev_date" value="<?php echo $b_dev_date; ?>"  require /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="b_dev_note" rows="4" cols="40" require><?php echo $b_dev_note; ?></textarea><br /></td>
</tr>
<tr>
            <td>ลงชื่อ หน.ส่วนงาน M: </td>
            <td><input type="text" name="b_dev_name" value="<?php echo $b_dev_name; ?>"  require/></td>
</tr>
    <tr>
        <td>
            <hr>
...
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="b1_dev_note" rows="4" cols="40" readonly><?php echo $b1_dev_note; ?></textarea><br /></td>
</tr>
<tr>
    ...
    <tr>
            ...
            <td><select name="bit_dev_status" id="bit_dev_status" disabled="true" hidden>
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            ...
            <td><input type="date" name="bit_dev_date" value="<?php echo $bit_dev_date; ?>"  hidden /></td>
</tr>
<tr>
            <td hidden>หมายเหตุคำขอ : </td>
            <td><textarea name="bit_dev_note" rows="4" cols="40" hidden ><?php echo $bit_dev_note; ?></textarea><br /></td>
</tr>
<tr>
            <td hidden>ลงชื่อ หน.ส่วนงาน IT: </td>
            <td><input type="text" name="bit_dev_name" value="<?php echo $bit_dev_name; ?>"  hidden /></td>
</tr>
  
    <tr>
            <td>ความเห็นผู้อำนวยการ IT: </td>
            <td><select name="bit1_dev_status" id="bit1_dev_status" >
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            <td>วันที่ให้ความเห็น : </td>
            <td><input type="date" name="bit1_dev_date" value="<?php echo $bit1_dev_date; ?>"  required /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="bit1_dev_note" rows="4" cols="40" required><?php echo $bit1_dev_note; ?></textarea><br /></td>
</tr>
<tr>
            <td>ลงชื่อผู้อำนวยการ IT: </td>
            <td><input type="text" name="bit1_dev_name" value="<?php echo $bit1_dev_name; ?>"  required /></td>
</tr>
    <tr>
        <td>
            <hr>
...
<!--tr>
            ...
            <td><input type="date" name="servicedevdate" value="<?php echo $servicedevdate; ?>" readonly /></td>
</tr>
<tr>
            <td>หมายเหตุ การบริการ :</td>
            <td><textarea name="servicedevnote" rows="4" cols="40" readonly><?php echo $servicedevnote; ?></textarea></td>
</tr>
<tr>
            <td>ผู้ให้บริการ : </td>
            <td><input type="text" name="servicedevname" value="<?php echo $servicedevname; ?>" readonly /></td>
</tr>
<tr>
    <td>
        <hr>
