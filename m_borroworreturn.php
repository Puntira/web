...
<section class="content-header">
  <div class="container-fluid"> 
    ...
    </i> รายการข้อมูลขอใช้อุปกรณ์คอมพิวเตอร์ พนักงาน/ลูกจ้าง</h1>
    </div><!-- /.container-fluid -->
  </section>
  <!-- Main content -->
  ...
  <?php include('mysql/config.php');
              ...
              ASC, memberdate DESC, memberid ASC";
...
<h1>แบบฟอร์มขอใช้อุปกรณ์</h1>

<form action="m_insert_borr.php" method="POST">
            <input type="text" name="ID" value="<?php echo $_SESSION['UserID'] ?>" placeholder="ID *" size="16" readonly /><br /><br />
            <input type="text" name="requesterbr" value="<?php echo $_SESSION['User'];?>" placeholder="ผู้แจ้ง *" size="44" readonly /><br /><br />
            <input type="text" name="requesteridbr" value="" placeholder="รหัส *" pattern="[0-9]{5}" title="กรอกรหัสพนักงาน หรือ ลูกจ้างไม่ถูกต้อง" required />
            <br /><br />
            <select name="Position" id="Positionbr">
            ...
            <br /><br />
            <input type="text" name="telinbr" value="" placeholder="โทรภายใน *"  required /><br /><br />
            
           <b>รายการอุปกรณ์</b> <br />


    <select name="requestcasebr">
    ...
    <input type="text" name="codeitembr" value="" placeholder="รหัสครุภัณฑ์" /><br /><br /> 

    <textarea name="requestnotebr" placeholder="เพื่อใช้ในงาน(รายละเอียด) *" rows="4" cols="40" required></textarea><br /><br />
...
<?php
echo "<script>";
echo "alert(\"ข้าพเจ้าจะรับผิดชอบต่อเครื่องฯ ของ อคส.ที่ขอยืมเพื่อใช้ในการปฎิบัติงาน และจะส่งคืนเครื่องเมื่อใช้ปฎิบัติงานเสร็จแล้ว หรือเมื่อพ้นจากการปฎิบัติหน้าที่ เมื่อพ้นจากการปฎิบัติหน้าที่ หรือเมื่อพ้นจากการเป็นพนักงาน อคส. ได้แก่ การออกจากงาน การเกษียณอายุ หรือ อื่นๆและจะไม่โอนเครื่องให้กับผู้อื่น หากข้าพเจ้าไม่นำเครื่องฯ ที่ได้ขอยืมไปใช้งานมาคืน ข้าพเจ้ายินยอมให้ อคส. หักเงินค่าเครื่องฯ จากเงินรายได้ที่ข้าพเจ้าพึงได้รับจาก อคส. ทั้งเงินเดือน เงินบำเหน็จ หรือ เงินได้อื่นใด หากไม่มีเงินได้ให้หัก ข้าพเจ้าจะนำเงินสดมาชำระให้ อคส. ตามมูลค่าทรัพย์สินของเครื่องฯ ดังกล่าว\");"; 
echo "</script>"; 
