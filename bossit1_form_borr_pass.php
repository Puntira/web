...
<table width="500">
        ...
        <form action="bossit1_update_borr_pass.php" method="POST">
<tr>
...
<tr>
            ...
            <td><input type="text" value="<?php echo date("m/d/Y",strtotime("+543 year".$requestdatebr)); ?>" readonly /></td>
</tr>
<tr>
            <td>ผู้แจ้ง : </td>
...
<tr>
            ...
            <td><select name="bit_borr_status" id="bit_borr_status" disabled="true" hidden>
...
<tr>
            ...
            <td><input type="date" name="bit_borr_date" value="<?php echo $bit_borr_date; ?>" hidden /></td>
</tr>
<tr>
            <td hidden>หมายเหตุคำขอ :</td>
            <td><textarea name="bit_borr_note" rows="4" cols="40" hidden><?php echo $bit_borr_note; ?></textarea></td>
</tr>
<tr>
            <td hidden>ลงชื่อ หน.ส่วนงาน IT: </td>
            <td><input type="text" name="bit_borr_name" value="<?php echo $bit_borr_name; ?>" hidden /></td>
</tr>
<tr>
    <td>
        <hr>
...
<tr>
            ...
            <td><select name="bit1_borr_status" id="bit1_borr_status">
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select></td>
...
<tr>
            ...
            <td><input type="date" name="bit1_borr_date" value="<?php echo $bit1_borr_date; ?>" required /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ :</td>
            <td><textarea name="bit1_borr_note" rows="4" cols="40"><?php echo $bit1_borr_note; ?></textarea></td>
</tr>
<tr>
            <td>ลงชื่อผู้อำนวยการ IT: </td>
            <td><input type="text" name="bit1_borr_name" value="<?php echo $bit1_borr_name; ?>" required /></td>
</tr>
<tr>
    <td>
        <hr>
