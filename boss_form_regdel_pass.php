...
<table width="500">
        ...
        <form action="boss_update_regdel_pass.php" method="POST">
<tr>
...
<tr>
            ...
            <td><input type="text"  value="<?php echo $syslevelname[$syslevel]; ?>" readonly></td>
</tr>
<tr>
            <td>สถานะ : </td>
...
<tr>
            ...
            <td><select name="b_sys_status" id="b_sys_status">
...
<tr>
            ...
            <td><input type="date" name="b_sys_date" value="<?php echo $b_sys_date; ?>"  require /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="b_sys_note" rows="4" cols="40" ><?php echo $b_sys_note; ?></textarea><br /></td>
</tr>
<tr>
            <td>ลงชื่อ หน.ส่วนงาน M: </td>
            <td><input type="text" name="b_sys_name" value="<?php echo $b_sys_name; ?>"  require/></td>
</tr>
    <tr>
        <td>
            <hr>
    ...
    <tr>
            ...
            <td><select name="b1_sys_status" id="b1_sys_status" disabled="true" hidden>
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            ...
            <td><input type="date" name="b1_sys_date" value="<?php echo $b1_sys_date; ?>"  hidden /></td>
</tr>
<tr>
            <td hidden>หมายเหตุคำขอ : </td>
            <td><textarea name="b1_sys_note" rows="4" cols="40" hidden><?php echo $b1_sys_note; ?></textarea><br /></td>
</tr>
<tr>
            <td hidden>ลงชื่อผู้อำนวยการ M: </td>
            <td><input type="text" name="b1_sys_name" value="<?php echo $b1_sys_name; ?>"  hidden/></td>
</tr>
...
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="bit_sys_note" rows="4" cols="40" readonly><?php echo $bit_sys_note; ?></textarea><br /></td>
</tr>
<tr>
...
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="bit1_sys_note" rows="4" cols="40" readonly><?php echo $bit1_sys_note; ?></textarea><br /></td>
</tr>
<tr>
