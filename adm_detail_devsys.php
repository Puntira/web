...
<table width="500">
        <h1>ข้อมูลการปรับปรุง/จัดทำระบบงาน</h1>
    <tr>
    ...
    <tr>
        ...
        <td><font color="green"><?php echo $posit_devsys; ?></font><br /></td>
</tr>
    <tr>
        <td><font color="orange">ส่วนงาน : </font></td>
        <td><font color="green"><?php echo $pwork_devsys; ?></font><br /></td>
</tr>
    <tr>
        <td><font color="orange">สำนัก : </font></td>
        <td><font color="green"><?php echo $offi_devsys; ?></font><br /></td>
</tr>
    <tr>
    ...
    <tr>
        ...
        <td><font color="green"><?php echo $lis_devsys; ?></font><br /></td>
   </tr>
   <tr>
