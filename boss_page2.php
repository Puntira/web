 ...
 <table id="example1" class="table table-bordered table-striped dataTable" 
              ...
              <thead>
                <tr role="row" class="info">
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;">สถานะผู้ยืม</th>

                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><label style="color:green">ความเห็น หน.ส่วนงาน M</label></th>
                ...
                <tr>
                    <td><center><?php echo $requestnumbr;?></center></td>
                     <td><center><?php echo $ID;?></center></td>
                        ...
                        <td><?php echo $requestcasebrname[$requeststatusbr];?></td>
                  ...
                  <td>
                    <a class="btn btn-info btn-xs" href="boss_detail_borr_pass.php?requestnumbr=<?php echo $requestnumbr;?>">
                      <i class="fas fa-eye">
                      </i>
                   
                    </a>                         
                   <a class="btn btn-warning btn-xs" href="boss_form_borr_pass.php?requestnumbr=<?php echo $requestnumbr; ?>">
