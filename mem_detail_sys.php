...
<table width="500" >
    ...
    <tr>
        <td><font color="orange">เลขที่ขอใช้ : </font></td>
  ...
  <tr>
    ...
    <tr>
        <td><font color="orange">วันที่ขอใช้ : </font></td>
        <td><font color="green"><?php echo $systemdate; ?></font></td>
</tr>
    <tr>
        <td><font color="orange">ผู้ขอใช้ : </font></td>
    ...
    <tr>
        ...
        <td><font color="green"><?php echo $posit_sys; ?></font><br /></td>
</tr>
    <tr>
        <td><font color="orange">ส่วนงาน : </font></td>
        <td><font color="green"><?php echo $pwork_sys; ?></font><br /></td>
</tr>
    <tr>
        <td><font color="orange">สำนัก : </font></td>
        <td><font color="green"><?php echo $offi_sys; ?></font><br /></td>
</tr>
    <tr>
