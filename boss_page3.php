            ...
            <table id="example1" class="table table-bordered table-striped dataTable" 
              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                ...
                <tr>
                  ...
                  <td>
                        <a class="btn btn-info btn-xs" href="boss_detail_ser_pass.php?memberid=<?php echo $memberid;?>" 
                      >
                      <i class="fas fa-eye">
                      </i>
                   
                    </a>                         
                   <a class="btn btn-warning btn-xs" href="boss_form_ser_pass.php?memberid=<?php echo $memberid; ?>" >
