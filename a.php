...
<form name="frmSearch" method="get" action="<?=$_SERVER['SCRIPT_NAME'];?>">
      ...
      <div align="lift"> 
           <a href="../itservice/admin_page.php">   
...
<div align="center">  
      ...
      <input name="reportmonth" type="text" id="reportmonth" value="<?php echo $_GET["reportmonth"];?>" ></br></br> 
...
$strSQL = "SELECT * FROM user WHERE ( Regidate LIKE '%".$_GET["reportmonth"]."%' )";
...
<?php }?>
 ...
 <center>
  <?php $sql = "select Userlevel, COUNT(ID) AS ID FROM user GROUP BY Userlevel";
  $result = mysql_query($sql);
  while($row = mysql_fetch_array($result)){
 echo " <button> " . $Userlevelname[$row['Userlevel']]. " ทั้งหมดจำนวน = ". $row['ID']; } ?>
 </center>
...
<!-- /.content -->
<?php require('C:\AppServ\www\itservice\adm_footer.php'); ?>
<script>
$(function () {
$(".datatable").DataTable();
$('#example2').DataTable({
