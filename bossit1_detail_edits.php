...
<table width="500">
    ...
    <tr>
        ...
        <td><font color="green"><?php echo $ID; ?></font>
...
<tr>
        ...
        <div align="left">
                    ...
                    <a class="btn btn-warning btn-xs" href="bossit1_page.php" >
                   ...
                   <a class="btn btn-warning btn-xs" href="bossit1_edits.php?ID=<?php echo $_SESSION["UserID"]=$ID; ?>" >
