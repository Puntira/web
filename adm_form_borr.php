...
$positionbr = $row['positionbr'];
$workbr = $row['workbr'];
$partworkbr = $row['partworkbr'];
$officebr = $row['officebr'];
$telinbr = $row['telinbr'];
...
<table width="500">
        ...
        <form action="adm_update_borr.php" method="POST">
<tr>
...
<tr>
            <td>ตำแหน่ง : </td>
            <td><input type="text" value="<?php echo $positionbr; ?>" readonly /></td>
</tr>
<tr>
            <td>งาน : </td>
            <td><input type="text" value="<?php echo $workbr; ?>" readonly /></td>
</tr>
<tr>
            <td>ส่วนงาน : </td>
            <td><input type="text" value="<?php echo $partworkbr; ?>" readonly /></td>
</tr>
<tr>
            <td>สำนัก : </td>
            <td><input type="text" value="<?php echo $officebr; ?>" readonly /></td>
</tr>
<tr>
            <td>โทร : </td>
...
<tr>
            ...
            <td><select name="b_borr_status" id="b_borr_status" disabled="true">
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
            <input type="text" name="b_borr_status" value="<?php echo $b_borr_status;?>" hidden>
            </td>
</tr>
<tr>
            <td>วันที่ให้ความคิดเห็น :</td>
            <td><input type="date" name="b_borr_date" value="<?php echo $b_borr_date; ?>" readonly /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ :</td>
            <td><textarea name="b_borr_note" rows="1" cols="25" readonly><?php echo $b_borr_note; ?></textarea></td>
</tr>
<tr>
            <td>ลงชื่อ หน.ส่วนงาน M: </td>
            <td><input type="text" name="b_borr_name" value="<?php echo $b_borr_name; ?>" readonly /></td>
</tr>
<tr>
    <td>
        <hr>
...
<tr>
            ...
            <td><select name="b1_borr_status" id="b1_borr_status" disabled="true">
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            <td>วันที่ให้ความคิดเห็น :</td>
            <td><input type="date" name="b1_borr_date" value="<?php echo $b1_borr_date; ?>" readonly /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ :</td>
            <td><textarea name="b1_borr_note" rows="1" cols="25" readonly><?php echo $b1_borr_note; ?></textarea></td>
</tr>
<tr>
            <td>ลงชื่อผู้อำนวยการ M: </td>
            <td><input type="text" name="b1_borr_name" value="<?php echo $b1_borr_name; ?>" readonly /></td>
</tr>
<tr>
    <td>
        <hr>
...
<tr>
            ...
            <td><select name="bit_borr_status" id="bit_borr_status" disabled="true">
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
            <input type="text" name="bit_borr_status" value="<?php echo $bit_borr_status;?>" hidden>
            </td>
</tr>
<tr>
            <td>วันที่ให้ความคิดเห็น :</td>
            <td><input type="date" name="bit_borr_date" value="<?php echo $bit_borr_date; ?>" readonly /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ :</td>
            <td><textarea name="bit_borr_note" rows="1" cols="25" readonly><?php echo $bit_borr_note; ?></textarea></td>
</tr>
<tr>
            <td>ลงชื่อ หน.ส่วนงาน M: </td>
            <td><input type="text" name="bit_borr_name" value="<?php echo $bit_borr_name; ?>" readonly /></td>
</tr>
<tr>
    <td>
        <hr>
...
<tr>
            ...
            <td><select name="bit1_borr_status" id="bit1_borr_status" disabled="true">
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            <td>วันที่ให้ความคิดเห็น :</td>
            <td><input type="date" name="bit1_borr_date" value="<?php echo $bit1_borr_date; ?>" readonly /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ :</td>
            <td><textarea name="bit1_borr_note" rows="1" cols="25" readonly><?php echo $bit1_borr_note; ?></textarea></td>
</tr>
<tr>
            <td>ลงชื่อ หน.ส่วนงาน M: </td>
            <td><input type="text" name="bit1_borr_name" value="<?php echo $bit1_borr_name; ?>" readonly /></td>
</tr>
<tr>
    <td>
        <hr>
...
<tr>
            <td>วันที่ขอยืมใช้ :</td>
            <td><input type="date" name="borrowdate" value="<?php echo $borrowdate; ?>" required/></td>
</tr>
<tr>
            <td>หมายเหตุ การขอยืมใช้ :</td>
            <td><textarea name="borrownote" rows="4" cols="40"><?php echo $borrownote; ?></textarea></td>
</tr>
<tr>
            <td>ผู้ให้การยืม : </td>
            <td><input type="text" name="supporterbr" value="<?php echo $supporterbr; ?>" required /></td>
</tr>
<tr>
    <td>
        <hr>
...
<tr>
            <td>หมายเหตุ การคืน :</td>
            <td><textarea name="returnnote" rows="4" cols="40"><?php echo $returnnote; ?></textarea></td>
</tr>
<tr>
            <td>ผู้รับคืน : </td>
            <td><input type="text" name="supporterre" value="<?php echo $supporterre; ?>" /></td>
</tr>
<tr>
    <td>
        <hr>
