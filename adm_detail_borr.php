...
<table width="500">
    ...
    <tr>
        <td><font color="orange">ชื่อผู้ขอยืมใช้ : </font></td>
    ...
    <tr>
        ...
        <td><font color="green"><?php echo $positionbr; ?></font><br /></td>
</tr>
    <tr>
        <td><font color="orange">งาน : </font></td>
        <td><font color="green"><?php echo $workbr; ?></font><br /></td>
</tr>
    <tr>
        <td><font color="orange">ส่วนงาน : </font></td>
        <td><font color="green"><?php echo $partworkbr; ?></font><br /></td>
</tr>
    <tr>
        <td><font color="orange">สำนัก : </font></td>
        <td><font color="green"><?php echo $officebr; ?></font><br /></td>
</tr>
    <tr>
...
<tr>
        <td>หมายเหตุการขอยืมใช้ : </td>
        <td><div style="padding-left: 5px;">
            <?php echo preg_replace("/\r?\n/", "<br />", $borrownote); ?>
        </div></td>
    </tr>
<tr>
        <td>ผู้ให้ขอยืมใช้ : </td>
