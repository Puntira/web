...
<table width="500">
        ...
        <form action="bossit1_update_regdel_pass.php" method="POST">
<tr>
...
<tr>
            ...
            <td><input type="text" value="<?php echo date("d/m/Y",strtotime("+543 year".$systemdate)); ?>" readonly /></td>
</tr>
<tr>
...
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="b_sys_note" rows="4" cols="40" readonly><?php echo $b_sys_note; ?></textarea><br /></td>
</tr>
<tr>
...
<tr>
    ...
    <tr>
            ...
            <td><select name="bit_sys_status" id="bit_sys_status" hidden>
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
    ...
    <tr>
            ...
            <td><select name="bit1_sys_status" id="bit1_sys_status" >
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            <td>วันที่ให้ความเห็น : </td>
            <td><input type="date" name="bit1_sys_date" value="<?php echo $bit1_sys_date; ?>" required/></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="bit1_sys_note" rows="4" cols="40" required><?php echo $bit1_sys_note; ?></textarea><br /></td>
</tr>
<tr>
            <td>ลงชื่อผู้อำนวยการ IT: </td>
            <td><input type="text" name="bit1_sys_name" value="<?php echo $bit1_sys_name; ?>"  required/></td>
</tr>
    <tr>
        <td>
            <hr>
