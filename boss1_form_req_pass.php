...
<table width="500">
        ...
        <form action="boss1_update_req_pass.php" method="POST">
<tr>
...
<tr>
            ...
            <td><select name="requeststatus" id="requeststatus" disabled="true">
                <option value="1" readonly>รออนุมัติ</option>
                <option value="2" readonly>ไม่อนุญาติ</option>
                <option value="3" readonly>อนุญาติ</option>
            </select>
...
<tr>
            <td hidden>คำขอ : </td>
            <td><select name="b_req_status" id="b_req_status" disabled="true" hidden>
...
<tr>
            ...
            <td><input type="date" name="b_req_date" value="<?php echo $b_req_date; ?>" hidden /></td>
</tr>
<tr>
            <td hidden>หมายเหตุคำขอ : </td>
            <td><textarea name="b_req_note" rows="4" cols="40" hidden ><?php echo $b_req_note; ?></textarea><br /></td>
</tr>
<tr>
            <td hidden>ผู้ให้ความเห็น : </td>
            <td><input type="text" name="b_req_name" value="<?php echo $b_req_name; ?>"  hidden /></td>
</tr>
<!----boss4---->
...
<tr>
            ...
            <td><select name="b1_req_status" id="b1_req_status">
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select></td>
...
<tr>
            ...
            <td><input type="date" name="b1_req_date" value="<?php echo $b1_req_date; ?>"  required /></td>
</tr>
<tr>
            <td>หมายเหตุความเห็น : </td>
            <td><textarea name="b1_req_note" rows="4" cols="40" ><?php echo $b1_req_note; ?></textarea><br /></td>
</tr>
<tr>
            <td>ลงชื่อผู้อำนวยการ M: </td>
            <td><input type="text" name="b1_req_name" value="<?php echo $b1_req_name; ?>"  required/></td>
</tr>
<!----boss5---->
<tr>
    <td>
