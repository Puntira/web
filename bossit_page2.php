...
<section class="content-header">
  ...
  <section class="content">
    ...
    <div class="card-header card-navy card-outline">
              ...
              ASC, requestdatebr DESC, requestdatebr ASC";
 ...
 <table id="example1" class="table table-bordered table-striped dataTable" 
              ...
              <thead>
                <tr role="row" class="info">
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 5%;">ชื่อผู้ยืม</th>
              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-xs" href="bossit_detail_borr_pass.php?requestnumbr=<?php echo $requestnumbr;?>" 
                      >
                      <i class="fas fa-eye">
                      </i>
                   
                    </a>                         
                   <a class="btn btn-warning btn-xs" href="bossit_form_borr_pass.php?requestnumbr=<?php echo $requestnumbr; ?>">
