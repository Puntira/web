...
<section class="content-header">
  <div class="container-fluid"> 
    ...
    </i> แบบฟอร์มสำหรับขอปรับปรุง/จัดทำระบบงาน </h1>
    </div><!-- /.container-fluid -->
  </section>
  <!-- Main content -->
...
<html>
    ...
    <body ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false"> 
        ...
        <form action="m_insert_dev_system.php" method="POST" enctype="multipart/form-data">

       <input type="text" name="ID" value="<?php echo $_SESSION['UserID'];?>" placeholder="ID *" size="24" readonly /><br /><br />
       <input type="text" name="fname_devsys" value="<?php echo $_SESSION['User']; ?>" placeholder="ผู้แจ้ง *" size="46" readonly /><br /><br />
       <input type="text" name="id_devsys" value="" placeholder="รหัส *"  required /><br /><br />
       ...
       <input type="text" name="tel_devsys" value="" placeholder="โทรภายใน *"  required /><br /><br />
       <label>ผู้ใช้งานระบบ</label><br>
       <input type="text" name="name_devsys" value="" placeholder="ชื่อระบบงาน *"  required /><br /><br />

       <!--hide notice: undefined index:-->
       <input type="text" name="devsys_status" value="" hidden>
       <input type="text" name="b_dev_status" value="" hidden>
       <input type="text" name="b1_dev_status" value="" hidden>
       <input type="text" name="bit_dev_status" value="" hidden>
       <input type="text" name="bit1_dev_status" value="" hidden>
       



    <b>มีความประสงค์</b><br/>
    <select name="lis_devsys">
        <option value="" disabled selected>กรุณาเลือก..</option>
        <option value="ปรับปรุง">ปรับปรุงระบบงาน</option>
        <option value="จัดทำระบบงาน">จัดทำระบบงาน</option>
        <option value="อื่นๆ">อื่นๆ</option>
    </select> &nbsp; &nbsp; <br /><br />

  <b>ภาพประกอบ</b><br/>
  <input type= "file" name= "image"  accept="image/*,.pdf"  /><br /><br />



    <textarea name="note_devsys" placeholder="เนื่องจากสาเหตุ *" rows="4" cols="50" required></textarea><br /><br />

    
            
            <button type="submit" value="Submit" name="Submit">ตกลง</button>
