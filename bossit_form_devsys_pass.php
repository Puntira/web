...
<table width="500">
        ...
        <form action="bossit_update_devsys_pass.php" method="POST">
<tr>
            <td>เลขที่ขอ : </td>
...
<tr>
    ...
    <tr>
            ...
            <td><select name="bit_dev_status" id="bit_dev_status" >
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            <td>วันที่ให้ความเห็น : </td>
            <td><input type="date" name="bit_dev_date" value="<?php echo $bit_dev_date; ?>"  required /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="bit_dev_note" rows="4" cols="40" required><?php echo $bit_dev_note; ?></textarea><br /></td>
</tr>
<tr>
            <td>ลงชื่อ หน.ส่วนงาน IT: </td>
            <td><input type="text" name="bit_dev_name" value="<?php echo $bit_dev_name; ?>"  required/></td>
</tr>
    <tr>
        <td>
            <hr>
    ...
    <tr>
            ...
            <td><select name="bit1_dev_status" id="bit1_dev_status" disabled="true" hidden>
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            ...
            <td><input type="date" name="bit1_dev_date" value="<?php echo $bit1_dev_date; ?>"  hidden /></td>
</tr>
<tr>
            <td hidden>หมายเหตุคำขอ : </td>
            <td><textarea name="bit1_dev_note" rows="4" cols="40" hidden><?php echo $bit1_dev_note; ?></textarea><br /></td>
</tr>
<tr>
            <td hidden>ลงชื่อผู้อำนวยการ IT: </td>
            <td><input type="text" name="bit1_dev_name" value="<?php echo $bit1_dev_name; ?>"  hidden/></td>
</tr>
