...
<div align="left"> 
    ...
    <a href="bossit1_form_borr_pass.php?requestnumbr=<?php echo $requestnumbr; ?>">   
    <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#exampleModal">
...
<tr>
    ...
    <tr>
        ...
        <td><font color="green"><?php echo date("d/m/Y",strtotime("+543 year".$requestdatebr)); ?></font></td>
</tr>
    <tr>
    ...
    <tr>
        ...
        <td><font color="green"><?php echo $requestcasebrname[$requestcasebr]; ?></font><br /></td>
   </tr>
<tr>     
