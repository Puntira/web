            ...
            <table id="example1" class="table table-bordered table-striped dataTable" 
              ...
              <thead>
                <tr role="row" class="info">
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 7%;">สถานะผู้แจ้ง</th>
              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-xs" href="boss1_detail_req_pass.php?requestnum=<?php echo $requestnum;?>" 
                      >
                      <i class="fas fa-eye">
                      </i>
                   
                    </a>                         
                   <a class="btn btn-warning btn-xs" href="boss1_form_req_pass.php?requestnum=<?php echo $requestnum; ?>" >
