        ...
        <table id="example1" class="table table-bordered table-striped dataTable" 
              ...
              <thead>
                <tr role="row" class="info">
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 6%;">เลขที่ผู้ใช้</th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 6%;">เริมใช้ระบบ</th>
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 8%;">สำนัก</th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 8%;">ส่วนงาน</th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 8%;">งาน</th>
         
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 8%;">สถานะผู้ใช้</th>
              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                ...
                <tr>
                   <td><center><?php echo $ID;?></center></td>
                        <td><?php echo date("d / m / Y", strtotime("+543 year". $Regidate)); ?></td>
