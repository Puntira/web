...
<table width="500">
        ...
        <form action="bossit_update_ser_pass.php" method="POST">
<tr>
...
<tr>
            <td>รายละเอียด ระบบเครือข่าย : </td>
...
<tr>
            ...
            <td><select name="bit_ser_status" id="bit_ser_status">
...
<tr>
            ...
            <td><input type="date" name="bit_ser_date" value="<?php echo $bit_ser_date; ?>" required /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ :</td>
            <td><textarea name="bit_ser_note" rows="4" cols="40"><?php echo $bit_ser_note; ?></textarea></td>
</tr>
<tr>
            <td>ลงชื่อ หน.ส่วนงาน IT: </td>
            <td><input type="text" name="bit_ser_name" value="<?php echo $bit_ser_name; ?>" required /></td>
</tr>
<tr>
    <td>
        <hr>
...
<tr>
            ...
            <td><select name="bit1_ser_status" id="bit1_ser_status" disabled="true" hidden>
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            ...
            <td><input type="date" name="bit1_ser_date" value="<?php echo $bit1_ser_date; ?>" hidden /></td>
</tr>
<tr>
            <td hidden>หมายเหตุคำขอ :</td>
            <td><textarea name="bit1_ser_note" rows="4" cols="40" hidden><?php echo $bit1_ser_note; ?></textarea></td>
</tr>
<tr>
            <td hidden>ลงชื่อผู้อำนวยการ IT: </td>
            <td><input type="text" name="bit1_ser_name" value="<?php echo $bit1_ser_name; ?>" hidden /></td>
</tr>
<tr>
