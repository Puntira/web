          ...
          <div class="col-md-12">
              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-xs" href="boss_detail_regdel_pass.php?system_num=<?php echo $system_num;?>" 
                      >
                      <i class="fas fa-eye">
                      </i>
                    </a> 
                    <a class="btn btn-warning btn-xs" href="boss_form_regdel_pass.php?system_num=<?php echo $system_num; ?>" >
