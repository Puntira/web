...
<table width="500">
        ...
        <form action="bossit1_update_req_pass.php" method="POST">
<tr>
...
<tr>
            <td>วันที่แจ้ง : </td>
            <td><input type="text" value="<?php echo date("d/m/Y",strtotime("+543 year".$requestdate)); ?>" readonly /></td>
</tr>
<tr>
            <td>ผู้แจ้ง : </td>
...
<tr>
            <td>แจ้งปัญหา : </td>
            <td><input type="text" value="<?php echo $requestcasename[$requestcase]; ?>" readonly /></td>
</tr>
<tr>
            <td>รหัสครุภัณฑ์ : </td>
...
<tr>
            ...
            <td><select name="bit_req_status" id="bit_req_status" disabled="true" hidden>
...
<tr>
            ...
            <td><input type="date" name="bit_req_date" value="<?php echo $bit_req_date; ?>"  hidden /></td>
</tr>
<tr>
            <td hidden>หมายเหตุคำขอ : </td>
            <td><textarea name="bit_req_note" rows="4" cols="40" hidden><?php echo $bit_req_note; ?></textarea><br /></td>
</tr>
<tr>
            <td hidden>ผู้ให้ความเห็น : </td>
            <td><input type="text" name="bit_req_name" value="<?php echo $bit_req_name; ?>"  hidden/></td>
</tr>
<tr>
    <td>
        <hr>
...
<tr>
            ...
            <td><select name="bit1_req_status" id="bit1_req_status">
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            ...
            <td><input type="date" name="bit1_req_date" value="<?php echo $bit1_req_date; ?>"  required /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="bit1_req_note" rows="4" cols="40" ><?php echo $bit1_req_note; ?></textarea><br /></td>
</tr>
<tr>
            <td>ลงชื่อผู้อำนวยการ IT: </td>
            <td><input type="text" name="bit1_req_name" value="<?php echo $bit1_req_name; ?>"  required /></td>
</tr>
<tr>
    <td>
        <hr>
