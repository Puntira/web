          ...
          <table id="example1" class="table table-bordered table-striped dataTable" 
              ...
              <thead >
                <tr role="row" class="info">
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 4%;"><center>ID</center></th>
              ...
              <tbody> <!--ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false"-->
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info btn-xs" href="user_detail_his.php?useridnum=<?php echo $useridnum;?>" 
                      >
                      <i class="fas fa-eye"></i></a>  

                      <a class="btn btn-warning btn-xs" href="user_form_his.php?useridnum=<?php echo  $useridnum;?>" 
                      >
