...
<table width="500">
        ...
        <form action="bossit_update_regdel_pass.php" method="POST">
<tr>
...
<tr>
    ...
    <tr>
            ...
            <td><select name="b1_sys_status" id="b1_sys_status" hidden>
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
    ...
    <tr>
            ...
            <td><select name="bit_sys_status" id="bit_sys_status">
                <option value="1">รออนุมัติ</option>
                <option value="2">ไม่อนุญาติ</option>
                <option value="3">อนุญาติ</option>
            </select>
...
<tr>
            ...
            <td><input type="date" name="bit_sys_date" value="<?php echo $bit_sys_date; ?>"  required /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ : </td>
            <td><textarea name="bit_sys_note" rows="4" cols="40" ><?php echo $bit_sys_note; ?></textarea><br /></td>
</tr>
<tr>
            <td>ลงชื่อ หน.ส่วนงาน IT: </td>
            <td><input type="text" name="bit_sys_name" value="<?php echo $bit_sys_name; ?>"  required/></td>
</tr>
