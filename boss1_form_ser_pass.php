...
<table width="500">
        ...
        <form action="boss1_update_ser_pass.php" method="POST">
<tr>
...
<tr>
            <td>รายละเอียด ระบบฐานข้อมูล : </td>
...
<tr>
            ...
            <td><select name="b_ser_status" id="b_ser_status" disabled="true" hidden>
...
<tr>
            ...
            <td><input type="date" name="b_ser_date" value="<?php echo $b_ser_date; ?>" hidden /></td>
</tr>
<tr>
            <td hidden>หมายเหตุคำขอ :</td>
            <td><textarea name="b_ser_note" rows="4" cols="40" hidden><?php echo $b_ser_note; ?></textarea></td>
</tr>
<tr>
            <td hidden>ลงชื่อ หน.ส่วนงาน M: </td>
            <td><input type="text" name="b_ser_name" value="<?php echo $b_ser_name; ?>" hidden /></td>
</tr>

<tr>
            <td>ความเห็นผู้อำนวยการ M: </td>
            <td><select name="b1_ser_status" id="b1_ser_status" >
                <option value="1">รออนุมัติ  </option>
                <option value="2">ไม่อนุญาติ </option>
                <option value="3">อนุญาติ   </option>
            </select></td>
...
<tr>
            ...
            <td><input type="date" name="b1_ser_date" value="<?php echo $b1_ser_date; ?>" required /></td>
</tr>
<tr>
            <td>หมายเหตุคำขอ :</td>
            <td><textarea name="b1_ser_note" rows="4" cols="40"><?php echo $b1_ser_note; ?></textarea></td>
</tr>
<tr>
            <td>ลงชื่อผู้อำนวยการ M: </td>
            <td><input type="text" name="b1_ser_name" value="<?php echo $b1_ser_name; ?>" required /></td>
</tr>
<tr>
    <td>
        <hr>
