              ...
              <tbody ondragstart="return false" onselectstart="return false" oncopy="return false"  oncut="return false">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <!--a href="page1.html" onclick="javascript:window.open('page2.html');">click</a-->


                    <a class="btn btn-info btn-xs" href="bossit_detail_req_pass.php?requestnum=<?php echo $requestnum;?>" 
                      >
                      <i class="fas fa-eye">
                      </i>
                   
                    </a>                         
                   <a class="btn btn-warning btn-xs" href="bossit_form_req_pass.php?requestnum=<?php echo $requestnum; ?>" >
